...
public class DocumentationController {
    ...
    @PostMapping
    public ResponseEntity<DocumentationDto> createDocumentation(@PathVariable UUID projectId, @RequestBody DocumentationDto dto) {
        return ResponseEntity.ok(documentationService.createDocumentation(projectId, dto));
    }

    @PutMapping("/{docId}")
    public ResponseEntity<DocumentationDto> updateDocumentation(@PathVariable UUID projectId, @PathVariable Long docId, @RequestBody DocumentationDto dto) {
        return ResponseEntity.ok(documentationService.updateDocumentation(docId, dto));
    }

    @DeleteMapping("/{docId}")
    public ResponseEntity<Void> deleteDocumentation(@PathVariable UUID projectId, @PathVariable Long docId) {
