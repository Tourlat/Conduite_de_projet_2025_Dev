...
public class ProjectControllerTest extends IntegrationTestWithDatabase {
  ...
  void updateIssue_success_updates_issue() throws Exception {
      ...
      var createBody = Map.of("name", "Project For Update", "description", "desc", "user",
              Map.of("id", owner.getId(), "email", owner.getEmail()));
      ...
      var issueBody = Map.of("title", "Original Title", "description", "Original description",
              "storyPoints", 5, "priority", "MEDIUM", "status", "TODO");
      ...
      var updateBody = Map.of("title", "Updated Title", "description", "Updated description",
              "storyPoints", 8, "priority", "HIGH", "status", "IN_PROGRESS");

      mockMvc
              .perform(put("/api/projects/" + projectId + "/issues/" + issueId)
                      .header("Authorization", "Bearer " + owner.getToken())
                      .contentType(MediaType.APPLICATION_JSON)
                      .content(objectMapper.writeValueAsString(updateBody)))
              .andExpect(status().isOk())
  ...
  void updateIssue_partial_update_only_status() throws Exception {
      ...
      var createBody = Map.of("name", "Project For Partial", "description", "desc", "user",
              Map.of("id", owner.getId(), "email", owner.getEmail()));
      ...
      var issueBody = Map.of("title", "Test Issue", "description", "Test",
              "storyPoints", 5, "priority", "MEDIUM", "status", "TODO");
  ...
  void deleteIssue_success_deletes_issue() throws Exception {
      ...
      var createBody = Map.of("name", "Project For Delete", "description", "desc", "user",
              Map.of("id", owner.getId(), "email", owner.getEmail()));
      ...
      var issueBody = Map.of("title", "Issue To Delete", "description", "Delete me",
              "storyPoints", 3, "priority", "LOW", "status", "TODO");
  ...
  void deleteIssue_unauthorized_user_forbidden() throws Exception {
      ...
      var createBody = Map.of("name", "Project For Delete Attack", "description", "desc", "user",
              Map.of("id", owner.getId(), "email", owner.getEmail()));
      ...
      var issueBody = Map.of("title", "Protected Issue", "description", "Protected",
              "storyPoints", 5, "priority", "HIGH", "status", "TODO");
